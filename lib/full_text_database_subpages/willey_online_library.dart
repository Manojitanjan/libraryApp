...
class WilleyOnlineLibrary extends StatefulWidget {
  @override
  _WilleyOnlineLibraryState createState() => _WilleyOnlineLibraryState();
}

class _WilleyOnlineLibraryState extends State<WilleyOnlineLibrary> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(  
          title: Text('Willey Online Library'),
          actions: <Widget>[
