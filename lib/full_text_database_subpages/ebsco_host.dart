...
class EbscoHost extends StatefulWidget {
  @override
  _EbscoHostState createState() => _EbscoHostState();
}

class _EbscoHostState extends State<EbscoHost> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: WebView(
        initialUrl:
            'http://web.a.ebscohost.com/ehost/search/selectdb?vid=0&sid=64300035-4341-4c6d-b262-349d8ed985e7%40sdc-v-sessmgr03',
