...
class EmeraldGroupPublishing extends StatefulWidget {
  @override
  _EmeraldGroupPublishingState createState() => _EmeraldGroupPublishingState();
}

class _EmeraldGroupPublishingState extends State<EmeraldGroupPublishing> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: Text('Emerald Group Publishing'),
          actions: <Widget>[
      ...
      body: WebView(
        initialUrl: 'https://www.emerald.com/insight/',
