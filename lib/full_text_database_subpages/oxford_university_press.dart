...
class OxfordUniversityPress extends StatefulWidget {
  @override
  _OxfordUniversityPressState createState() => _OxfordUniversityPressState();
}

class _OxfordUniversityPressState extends State<OxfordUniversityPress> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: Text('Oxford University Press'),
          actions: <Widget>[
      ...
      body: WebView(
        initialUrl: 'https://academic.oup.com/journals/',
