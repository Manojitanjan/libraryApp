...
class ImfELibrary extends StatefulWidget {
  @override
  _ImfELibraryState createState() => _ImfELibraryState();
}

class _ImfELibraryState extends State<ImfELibrary> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: WebView(
        initialUrl:
            'https://www.elibrary.imf.org/search?t100=urn:Series/022&type_0=booksandjournals&browsePage=countries&sort=datedescending&redirect=true&redirect=true',
