...
class EJournals extends StatefulWidget {
  @override
  _EJournalsState createState() => _EJournalsState();
}

class _EJournalsState extends State<EJournals> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: WebView(
        initialUrl:
            'https://library.kln.ac.lk/index.php/component/sppagebuilder/?view=page&id=70',
