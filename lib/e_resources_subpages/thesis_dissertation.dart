...
class ThesisDissertation extends StatefulWidget {
  @override
  _ThesisDissertationState createState() => _ThesisDissertationState();
}

class _ThesisDissertationState extends State<ThesisDissertation> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: Text('Thesis and Dissertation'),
          actions: <Widget>[
      ...
      body: WebView(
        initialUrl: 'http://repository.kln.ac.lk/handle/123456789/198',
